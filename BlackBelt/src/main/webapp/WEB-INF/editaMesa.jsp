...
<form:form action="" method="POST" modelAttribute="mesa" cssClass="container form ancho">
    ...
    <p class="form-outline">
        ...
        <form:input cssClass="form-control" value="${mesaAEditar.nombreInvitado}" path="nombreInvitado"/>
    </p>
    <p class="form-outline">
        ...
        <form:input type="number" min="1" max="10" cssClass="form-control" value="${mesaAEditar.cantidadInvitados}" path="cantidadInvitados"/>
    </p>
    <p class="form-outline">
        <form:label cssClass="form-label" path="nota">Nota</form:label>
        <form:errors cssClass="text-danger" path="nota"/>
        <form:textarea cssClass="form-control" value="${mesaAEditar.nota}" path="nota"/>
    </p>
    <input type=hidden value=0 name=number>
    <input class="btn btn-outline-secondary" type="submit" value="Crear Mesa"/>
</form:form>
<a class="text-center " href="/home">Cancel</a>
<a class="text-center btn btn-danger " href="/delete/${mesaAEditar.id}">Eliminar Mesa</a>
</body>